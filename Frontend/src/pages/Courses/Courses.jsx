        ...
        <header className="height-75">
          <div className="container h-100 d-flex flex-column align-items-center justify-content-center text-light">
            ...
            <p className="text-center w-75 mb-5">
              ...
              odio eos distinctio ducimus! Modi quaerat dolores illo accusamus
              maxime cupiditate culpa minus animi repellat autem!
            </p>
          </div>
        </header>
              ...
              <div className="d-row d-md-flex justify-content-between align-items-center">
                ...
                <div className="col-12 col-md-6 col-lg-7">
                  <ul className="list-unstyled mb-0">
                    <li>
                      <p>Main Address - 47 Street Name,Banglore</p>
                    </li>
                    <li>
                      <p>Phone Number - 0900800700</p>
                    </li>
                    <li>
                      <p>Email -masai@university.co.Banglore</p>
                    </li>
                  </ul>
                </div>
              </div>
